	  ...
	  _createClass(StickyHeader, [{
	    ...
	    value: function createHeaderWaypoint() {
	      ...
	      new Waypoint({
	        ...
	        handler: function handler() {
	          _this.siteHeader.classList.toggle('site-header--dark');
	        }
	      });
	    }
	  }, {
	          ...
	          new Waypoint({
	            ...
	            handler: function handler(direction) {
	              if (direction == 'up') {
	                ...
	                try {
	                  for (var _iterator3 = _this2.headerLinks[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;/* WEBPACK VAR INJECTION */(function(global) {/*! smooth-scroll v16.0.3 | (c) 2019 Chris Ferdinandi | MIT License | http://github.com/cferdinandi/smooth-scroll */
